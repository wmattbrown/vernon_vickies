...
hicham <- set_player(player = "Hicham",
                     character = "Ryker, cleric, human",
                     notes = "Found burried/cucooned in the underdark near the Fog Fjord while searching for the source of the fog.") 

player_stats <- Reduce(dplyr::bind_rows, list(willy, alex, fetwi, phil, mohamed, andrei, hicham))
